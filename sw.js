const CACHE_NAME = 'ck-panel-shell-v176-chat-v156-api-owner';
const SHELL_ASSETS = [
  './',
  './index.html',
  './version.json',
  './tokens.css?v=chat-v156-api-owner',
  './style.css?v=chat-v156-api-owner',
  './polish.css?v=chat-v156-api-owner',
  './chat.css?v=chat-v156-api-owner',
  './wechat.css?v=chat-v156-api-owner',
  './visual-overrides.css?v=chat-v156-api-owner',
  './shell.css?v=chat-v156-api-owner',
  './components.css?v=chat-v156-api-owner',
  './script.js?v=chat-v156-api-owner',
  './script-extra.js?v=chat-v156-api-owner',
  './pwa.js?v=chat-v156-api-owner',
